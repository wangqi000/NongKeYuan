...
<div class="content">
	<!-- BEGIN LOGIN FORM -->
	<form class="login-form" action="rest/user/login" method="get">
		...
		<div class="form-group">
			...
			<div class="input-icon">
				...
				<input name="login_name" id="login_name" size="25" value="glory" class="form-control placeholder-no-fix" type="text" autocomplete="off" placeholder="用户名" />
			</div>
		</div>
		<div class="form-group">
